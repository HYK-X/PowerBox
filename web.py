...
def Homepage(page: ft.Page):
    ...
    def onWindowEvent(e):
        ...
        if (e.data == "close"):
            ...
            ret = os.system("ping dav.jianguoyun.com -n 1")  # 修复无网状态已连接用户无法关闭的bug 2023.1.6
            if (webdav != None and ret == 0):
                delfile()
                upload()
            page.window_destroy()
...
ft.app(target=Homepage, assets_dir="assets", view=ft.WEB_BROWSER)
